...
#
# author Daniel Carreira
# date 2020-05-08 / updated: 2020-05-08
...
PROGRAM_OBJS=main.o memory.o auxFunc.o functions.o $(PROGRAM_OPT).o
...
# Dependencies
main.o: main.c memory.h auxFunc.h functions.h $(PROGRAM_OPT).h
$(PROGRAM_OPT).o: $(PROGRAM_OPT).c $(PROGRAM_OPT).h
auxFunc.o: auxFunc.c args.h auxFunc.h
functions.o: functions.c memory.h args.h functions.h auxFunc.h
